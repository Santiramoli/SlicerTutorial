...
class MyFirstModule(ScriptedLoadableModule):
    ...
    def __init__(self, parent):
        ...
        self.parent.title = _("Sphere-shaped model")
        self.parent.categories = [translate("qSlicerAbstractCoreModule", "Examples")]
        self.parent.dependencies = []
        self.parent.contributors = ["Santiago Ramoli, ULPGC"]
        self.parent.helpText = _(   
                                    """
                                        This is my first scriptable module. 
                                        The goal is to place a sphere-shaped model with two marking points.
                                        See more information in <a href="https://github.com/Santiramoli/SlicerTutorial.git"></a>.
                                    """
                                )
        self.parent.acknowledgementText = _("""This file is edited by Santiramoli.""")
        slicer.app.connect("startupCompleted()", registerSampleData)



# Register sample datasets in Sample Data module

def registerSampleData():

    """Add data sets to Sample Data module."""

    # Obtains the path where the thumbnail images are located.
